...
upgradeFragments=['FourMuPt_1_200_pythia8_cfi',
                  ...
                  'DsTau3mu_cff',
                  'BsToPhiPhi_cff',
                  'DisplacedSUSY_stopToBottom_cff',
                  'HSCPgluino_cff',
]
...
howMuches={'FourMuPt_1_200_pythia8_cfi':Kby(10,100),
           ...
           'BuToJpsiK_cff':Kby(5500,55000),
           'BdToKstarJpsi_cff':Kby(350,3500),
           'DsTau3mu_cff':Kby(1700,17000),
           'BsToPhiPhi_cff':Kby(180,1800),
           'DisplacedSUSY_stopToBottom_cff':Kby(50,200),
           'HSCPgluino_cff':Kby(10,100),
...
upgradeDatasetFromFragment={'FourMuPt_1_200_pythia8_cfi': 'FourMuPt1_200',
                  ...
                  'BuToJpsiK_cff':'BuToJpsiK',
                  'BdToKstarJpsi_cff':'BdToKstarJpsi',
                  'DsTau3mu_cff':'DsTau3mu',
                  'BsToPhiPhi_cff':'BsToPhiPhi',
                  'DisplacedSUSY_stopToBottom_cff':'DisplacedSUSY_stopToBottom',
                  'HSCPgluino_cff':'HSCPgluino',
                  'SMS-T1qqqq-LLChipm_cff':'SMS-T1qqqq-LLChipm',
                  'SMS-T1qqqq_ctau-1000_cff':'SMS-T1qqqq_ctau-1000',
