...
steps['RunHI2018']={'INPUT':InputInfo(dataSet='/HIMinimumBias0/Tier0_REPLAY_vocms015-v213/RAW',label='hi2018',run=[324401],events=10000,location='STD')}
steps['RunHI2018Reduced']={'INPUT':InputInfo(dataSet='/HIMinimumBiasReducedFormat0/Tier0_REPLAY_vocms015-v213/RAW',label='hi2018reduced',run=[324401],events=10000,location='STD')}
...
steps['HARVESTDHI18']=merge([{ '--era':'Run2_2018_pp_on_AA' },steps['HARVESTDHI15']])
