...
step1Up2018HiDefaults = merge ([{'--conditions':'auto:phase1_2018_realistic_hi','--era':'Run2_2018_pp_on_AA,pf_badHcalMitigation'},step1Up2017Defaults])
...
steps['HydjetQ_B12_5020GeV_2018_ppRecoINPUT']={'INPUT':InputInfo(dataSet='/Hydjet_Quenched_Drum5Ev8_PbPbMinBias_5020GeV_2018/HINPbPbSpring18GS-100X_upgrade2018_realistic_v10_ext1-v1/GEN-SIM',location='STD',events=10000)}
...
hiAlca2018_ppReco = {'--conditions':'auto:phase1_2018_realistic_hi', '--era':'Run2_2018_pp_on_AA,pf_badHcalMitigation'}
...
PUHI={'-n':10,'--pileup_input':'das:/Hydjet_Quenched_Drum5Ev8_PbPbMinBias_5020GeV_2018/HINPbPbSpring18GS-100X_upgrade2018_realistic_v10_ext1-v1/GEN-SIM'}
...
steps['DIGIHIMIX']=merge([{'-s':'DIGI:pdigi_hi,L1,DIGI2RAW,HLT:HIon', '-n':2}, hiDefaults2018_ppReco, {'--pileup':'HiMix','--pileup_dasoption':'"--limit 0"'}, PUHI, step2Upg2015Defaults])
...
step1Up2018HiMixDefaults = merge ([{'--beamspot':'MatchHI', '--pileup':'HiMixGEN', '--scenario':'HeavyIons', '--pileup_dasoption':'"--limit 0"'},hiDefaults2018_ppReco,PUHI,step1Up2018HiProdDefaults])
...
'--customise_commands' : '"from CalibTracker.Configuration.Common.PoolDBESSource_cfi import poolDBESSource ; process.newBS = poolDBESSource.clone(connect = cms.string(\'frontier://FrontierProd/CMS_CONDITIONS\'),toGet = cms.VPSet(cms.PSet(record = cms.string(\'BeamSpotObjectsRcd\'),tag = cms.string(\'BeamSpotObjects_Realistic25ns_13TeVCollisions_Early2017_v1_mc\')))) ; process.prefer_PreferNewBS = cms.ESPrefer(\'PoolDBESSource\', \'newBS\') "'                                 
},step3Up2015Defaults])
...
steps['RECOHIMIX']=merge([steps['RECOHI2018PPRECO'],{'--pileup':'HiMix','--pileup_input':'das:/Hydjet_Quenched_Drum5Ev8_PbPbMinBias_5020GeV_2018/HINPbPbSpring18GS-100X_upgrade2018_realistic_v10_ext1-v1/GEN-SIM'}])
