...
#        self.couchDB = 'reqmgr_config_cache'
    ...
    def prepare(self,mReader, directories, mode='init'):
        try:
            ...
            wmsplit['RECOHID15']=1
            wmsplit['DigiFull_2017']=5 # no more than 500 events per job 
            wmsplit['RecoFull_2017']=5 # no more than 500 events per job 
            wmsplit['DigiFullPU_2017PU']=2 # no more than 500 events per job 
            wmsplit['RecoFullPU_2017PU']=2 # no more than 500 events per job 
            wmsplit['DigiFull_2018']=5 # no more than 500 events per job 
            wmsplit['RecoFull_2018']=5 # no more than 500 events per job 
            wmsplit['DigiFullPU_2018PU']=2 # no more than 500 events per job 
            wmsplit['RecoFullPU_2018PU']=2 # no more than 500 events per job 
